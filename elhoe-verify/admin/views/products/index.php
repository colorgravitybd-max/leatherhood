...
<div class="card">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:14px;">
        ...
        <a href="/admin/?route=products/edit" class="btn btn-primary">+ New Product</a>
    </div>
            ...
            <?php foreach ($products as $p): ?>
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <a href="/admin/?route=products/edit&id=<?= (int) $p['id'] ?>" class="btn btn-sm">Edit</a>
                        <form method="post" action="/admin/?route=products/delete&id=<?= (int) $p['id'] ?>"
