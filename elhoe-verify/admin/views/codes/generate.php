...
<div class="card" style="max-width:720px;">
    ...
    <?php if (empty($products)): ?>
        <p style="color:var(--crimson)">
            ...
            <a href="/admin/?route=products/edit" class="btn btn-sm" style="margin-left:8px;">Add product</a>
        </p>
    <?php else: ?>
    <form method="post" action="/admin/?route=codes/generate" autocomplete="off">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-top:8px;">
            <a href="/admin/?route=codes" class="btn">Cancel</a>
...
<div class="card" style="max-width:720px;">
    ...
    <form method="post" action="/admin/?route=codes/import" enctype="multipart/form-data">
        <input type="hidden" name="csrf" value="<?= Helpers::e(Helpers::csrfToken()) ?>">
        <div class="form-row">
