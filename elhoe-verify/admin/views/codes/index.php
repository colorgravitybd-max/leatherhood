...
?>
<div class="card">
    <form method="get" action="/admin/" style="display:flex; flex-wrap:wrap; gap:10px; align-items:end;">
        ...
        <div style="display:flex; gap:6px;">
            ...
            <a href="/admin/?route=codes" class="btn">Reset</a>
        </div>

        <?php if ($batchFilter !== ''): ?>
            <a href="/admin/?route=codes/export&batch=<?= urlencode($batchFilter) ?>"
...
<div class="card">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:10px;">
        ...
        <a href="/admin/?route=codes/generate" class="btn btn-primary">+ New Batch</a>
    </div>
