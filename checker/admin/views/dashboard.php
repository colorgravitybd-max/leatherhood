...
<div class="card" style="margin-top:18px;">
    <div style="display:flex; justify-content:space-between; align-items:center;">
        ...
        <a href="<?= Helpers::e(BASE_PATH) ?>/admin/?route=insights/radar" class="btn btn-sm">Full radar →</a>
    </div>
...
<div class="card">
    <div style="display:flex; justify-content:space-between; align-items:center;">
        ...
        <a href="<?= Helpers::e(BASE_PATH) ?>/admin/?route=insights/expiry" class="btn btn-sm">Full list →</a>
    </div>
