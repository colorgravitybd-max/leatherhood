...
function nav_link(string $route, string $label, string $current): string {
    ...
    return '<a href="' . htmlspecialchars(BASE_PATH) . '/admin/?route=' . htmlspecialchars($route) . '" class="' . $cls . '">' . htmlspecialchars($label) . '</a>';
}
...
<div class="admin-shell">
    <aside class="admin-side">
        ...
        <a href="<?= Helpers::e(BASE_PATH) ?>/admin/?route=logout">Logout</a>
        <a href="<?= Helpers::e(BASE_PATH) ?>/" target="_blank" rel="noopener">View public portal ↗</a>
    </aside>
