...
final class Helpers
{
    ...
    {
        // Auto-prepend BASE_PATH for site-relative paths so callers can
        // write Helpers::redirect('/admin/?route=login') regardless of
        // whether the app is at the root or in a /checker subfolder.
        if ($path !== '' && $path[0] === '/'
    ...
    /** Build a site-relative URL with the BASE_PATH prefix. */
